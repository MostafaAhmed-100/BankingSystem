        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bankers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bankers_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerBankers", x => new { x.BankersId, x.customersId });
                    table.ForeignKey(
                        name: "FK_CustomerBankers_Bankers_BankersId",
                        column: x => x.BankersId,
                        principalTable: "Bankers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerBankers_Customers_customersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditCards_Accounts_AccountNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bankers_BranchId",
                table: "Bankers",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_Bankers_UserId",
                table: "Bankers",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerBankers_customersId",
                table: "CustomerBankers",
                column: "customersId");
